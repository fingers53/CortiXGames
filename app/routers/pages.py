...
async def memory_game(request: Request, current_user=Depends(get_current_user)):
    return render_template(templates, "memory_game.html", request, {"current_user": current_user})
...
async def reaction_game(request: Request, current_user=Depends(get_current_user)):
    return render_template(templates, "reaction_game.html", request, {"current_user": current_user})


@router.get("/leaderboard", response_class=HTMLResponse)
async def leaderboard(request: Request, current_user=Depends(get_current_user)):
    return render_template(templates, "leaderboard.html", request, {"current_user": current_user})
...
async def reaction_game_leaderboard(request: Request, current_user=Depends(get_current_user)):
    return render_template(templates, "reaction_leaderboard.html", request, {"current_user": current_user})
...
async def memory_game_leaderboard(request: Request, current_user=Depends(get_current_user)):
    return render_template(templates, "memory_leaderboard.html", request, {"current_user": current_user})
